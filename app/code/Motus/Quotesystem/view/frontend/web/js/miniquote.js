...
define([
    ...
    function initSidebar() {
        ...
        miniquote.sidebar({
            ...
            'url': {
                'checkout': window.quote.generateQuoteUrl,
                'update': window.quote.updateItemQtyUrl,
                'remove': window.quote.removeurl,
    ...
    return Component.extend({
        ...
        initialize: function () {
            var self = this,
            cartData = customerData.get('quotesection');
            customerData.reload('quotesection');
            ...
            if (
                ...
                customerData.reload(['quotesection'], false);
            }
