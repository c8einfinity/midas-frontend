 ...
 */
namespace Motus\Quotesystem\Model\ResourceModel\Quotes;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Motus\Quotesystem\Model\Quotes ::class,
            \Motus\Quotesystem\Model\ResourceModel\Quotes ::class
        );
