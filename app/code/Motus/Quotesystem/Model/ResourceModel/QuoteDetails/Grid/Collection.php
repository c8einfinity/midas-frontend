...
namespace Motus\Quotesystem\Model\ResourceModel\QuoteDetails\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Motus\Quotesystem\Model\ResourceModel\QuoteDetails\Collection as QuoteCollection;
...
class Collection extends QuoteCollection implements SearchResultInterface
{
    ...
    protected function _initSelect()
    {
        ...
        $joinTable = $this->getTable('mot_quotes');
        $this->getSelect()->join(
            $joinTable.' as qts',
            'main_table.entity_id = qts.quote_id'
        );
        $this->addFilterToMap('quote_id', 'qts.quote_id');
        $this->addFieldToFilter('quote_generate', 1);
        parent::_initSelect();
    }
