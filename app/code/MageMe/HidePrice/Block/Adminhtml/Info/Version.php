 ...
 */
namespace MageMe\HidePrice\Block\Adminhtml\Info;
...
/**
 * Class Version
 * @package MageMe\HidePrice\Block\Adminhtml
 */
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        if ($info &&
            ...
            $version .= ' | ' . __(
                    ...
                    $info['MageMe_HidePrice']['release_notes'],
                    $info['MageMe_HidePrice']['version']
                );
        }
