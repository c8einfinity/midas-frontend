...
define([
    ...
    return dynamicRows.extend({
        defaults: {
            ...
            dataScopeAssociatedProduct: 'data.finder_product_ids',
        ...
        deleteRecord: function (index) {
            ...
            if (!tmpArray.length) {
                this.attributesTmp = this.source.get('data.dropdowns');
                this.source.set('data.dropdowns', []);
                this.cacheGridData = [];
            }
        ...
        processingUnionInsertData: function (data) {
            ...
            if (dataCount > elemsCount) {
                _.each(this.getChildItems(), function (elemData, index) {
        ...
        processingInsertDataFromWizard: function (data) {
            ...
            _.each(data, function (row) {
                ...
                _.each(row.options, function (option) {
                    ...
                    attributesText += option['dropdown_label'] + ': ' + option.label;
                }, this);
                ...
                product = {
                    ...
                    'selected_options': JSON.stringify(row.options),
                ...
                product[this.canEditField] = false;
